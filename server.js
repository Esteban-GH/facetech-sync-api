...
const mysql = require('mysql'); // Cambiado a mysql en lugar de mysql2
...
const pool = mysql.createPool({
    ...
    connectionLimit: 10,
    queueLimit: 0,
    connectTimeout: 30000, // Aumentar tiempo de espera a 30 segundos
    acquireTimeout: 30000  // Tiempo máximo para adquirir una conexión
});
